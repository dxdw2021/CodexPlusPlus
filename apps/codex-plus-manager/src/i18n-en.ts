...
export const EN_PLAIN: Record<string, string> = {
  ...
  "主题状态": "Theme status",
  "查看和管理 Codex 主题的运行状态": "View and manage the Codex theme runtime state",
  "基础主题": "Base theme",
  "注入状态": "Injection status",
  "未运行": "Not running",
  "运行中 (PID: {0})": "Running (PID: {0})",
  "刷新状态": "Refresh status",
  "启动注入": "Start injection",
  "停止注入": "Stop injection",
  "正在检查状态...": "Checking status...",
  "为 Codex 桌面端应用注入主题皮肤，需 Node.js 22+ 环境": "Injects a theme skin into the Codex desktop app via CDP. Requires Node.js 22+.",
  ...
  "启用 Codex 主题 (Dream Skin)": "Enable Codex Theme (Dream Skin)",
  "Codex 主题": "Codex Theme",
  "通过 CDP 注入为 Codex 桌面端应用主题皮肤": "Apply a decorative skin to the Codex desktop app via CDP injection",
  "CDP 端口": "CDP port",
  "主题皮肤": "Theme Skin",
  "紫色梦境": "Purple Dream",
  "蓝色海洋": "Blue Ocean",
  "樱花纷飞": "Sakura Blossom",
  "安装基础主题": "Install base theme",
  "恢复基础主题": "Restore base theme",
